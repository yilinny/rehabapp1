...
let recipes = [
    ...
    // params passed in would be recipe, step. Step would be index allowing for it to be retrieved 
    {
        ...
        step:[
            ...
            {
                ing: [[0,2,3], [0,2,3,8],[0,2,2,3,8], [0,2,2,3,3,8], [0,2,2,3,2,3,8,8,8]]//take from fridge
            },
            {
                ing: [0],
            },
    ...
    }, //carbonara
    {
        ...
        step:[
            ...
            {
                ing: [[5,10,17], [14,5,10,17], [14,5,10,17], [14,1,5,10,17], [14,1,1,5,10,17]],
                adapt: {
                    fireNo:    1,
                    cookery: 'pan',
                    type : 'add'
    ...
    }, //fried rice
    {
        ...
        step:[
            ...
            {
                ing: [[8,7,10], [8,1,7,10],[8,1,7,10], [8,1,7,10,6], [8,1,7,10,10,6]],
                adapt: {
                    fireNo:    1,
                    cookery: 'pot',
                    type : 'add'
    ...
    },//curry
    {
        ...
        step:[
            ...
            {
                ing: [[7,3,18], [7,3,18,19],[7,3,18,19], [7,3,18,19,20],[7,7,3,18,19,20]]
    ...
    }, //sausage and mash
    {
        ...
        step:[
            ...
            {
                ing: [[5,21], [5,21,19], [5,21,19,20], [5,21,19,20,2]]
            }, //mixing batter 
            {
                ing: [2,15],
                adapt:{
    ...
    }, //fish and chips 
    {
        ...
        step:[
            ...
            {},//grate is empty
            {
                ing: [[0,8,13], [0,3,8,13],[0,3,18,10,13], [0,3,18,13,20,10],[0,3,13,8,10,19,20]]
            }, //mix salad
        ]
    }, //pasta salad
    {
        ...
        step:[
            ...
            {},//grate is empty
            {
                ing: [[7,8,13], [7,3,8,13],[7,3,18,10,13], [7,3,18,13,20,10],[7,3,13,8,10,19,20]]
            }, //mix salad
        ]
    }, //potato salad
